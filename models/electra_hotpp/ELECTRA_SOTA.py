...
from tools.density_conversions import normalize_density, cd_to_chgcar_mol, get_qm9_density
...
class QM9Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if not self.config["save_memory"]:
            ...
            return (qm9_density, qm9_mol, qm9_n_elec, qm9_grid_dict, mol_cd_file)
